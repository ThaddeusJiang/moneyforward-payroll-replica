...
const Page = () => {
  ...
  const query = useQuery({
    queryKey: ["payment-item-settings", "hourly"],
    queryFn: () => getPaymentItems("hourly"),
  });
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(["payment-item-settings", "hourly"]);
    },
  });
  ...
  return (
    <>
      ...
      <MainContent>
        <ConfigurationTabs />
        <PaymentItemTypeSwitch active="hourly" />
